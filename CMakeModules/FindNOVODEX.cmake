...
IF(PAL_MODULE_COPY)
	...
	FOREACH(CUR_LIB ${NOVODEX_LIBS})
		...
		ELSE(NOVODEX_LIBRARY_${CUR_LIB}_MODULE AND NOT NOVODEX_LIBRARY_MODULE_ERROR)
			SET(NOVODEX_LIBRARY "NOVODEX_LIBRARY-NOTFOUND")
			SET(NOVODEX_LIBRARY_MODULE_ERROR "YES")
		ENDIF(NOVODEX_LIBRARY_${CUR_LIB}_MODULE AND NOT NOVODEX_LIBRARY_MODULE_ERROR)
		...
		ELSE(NOVODEX_LIBRARY_${CUR_LIB}_MODULE_DEBUG AND NOT NOVODEX_LIBRARY_MODULE_DEBUG_ERROR)
			SET(NOVODEX_LIBRARY_DEBUG "NOVODEX_LIBRARY_DEBUG-NOTFOUND")
			SET(NOVODEX_LIBRARY_MODULE_DEBUG_ERROR "YES")
		ENDIF(NOVODEX_LIBRARY_${CUR_LIB}_MODULE_DEBUG AND NOT NOVODEX_LIBRARY_MODULE_DEBUG_ERROR)
	ENDFOREACH(CUR_LIB ${NOVODEX_LIBS})
