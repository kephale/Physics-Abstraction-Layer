...
FOREACH(CUR_LIB ${HAVOK_LIBS})
	...
	ELSE(HAVOK_LIBRARY_${CUR_LIB} AND NOT HAVOK_LIBRARY_ERROR)
		SET(HAVOK_LIBRARY "HAVOK_LIBRARY-NOTFOUND")
		SET(HAVOK_LIBRARY_ERROR "YES")
	ENDIF(HAVOK_LIBRARY_${CUR_LIB} AND NOT HAVOK_LIBRARY_ERROR)
	...
	ELSE(HAVOK_LIBRARY_${CUR_LIB}_DEBUG AND NOT HAVOK_LIBRARY_DEBUG_ERROR)
		SET(HAVOK_LIBRARY_DEBUG "HAVOK_LIBRARY_DEBUG-NOTFOUND")
		SET(HAVOK_LIBRARY_DEBUG_ERROR "YES")
	ENDIF(HAVOK_LIBRARY_${CUR_LIB}_DEBUG AND NOT HAVOK_LIBRARY_DEBUG_ERROR)
ENDFOREACH(CUR_LIB ${HAVOK_LIBS})


SET(HAVOK_FOUND "NO")
IF(HAVOK_LIBRARY AND HAVOK_INCLUDE_DIR)
  SET(HAVOK_FOUND "YES")
ENDIF(HAVOK_LIBRARY AND HAVOK_INCLUDE_DIR)
