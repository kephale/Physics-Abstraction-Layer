...
public:
	...
	std::string GetDescription() {
		return "This test visualizes the contact points from the collision subsystem. Simply drop a box, sphere, or cylinder onto the underlying terrain by pressing the following keys:\r\n 1 - Drops a box\r\n 2 - Drops a sphere\r\n 3 - Drops a cylinder.\r\n 4 - Drops a grid of cubes.\r\n 5 - Drops a compound body\r\n 6 - Drops a convex body\r\n 7 - Drops a compound convex body\r\n 8 - Randomly repositions a random body\r\n 9 - Deletes a body";
	}
